...
// 是否大于等于IOS11
#define IS_IOS11_LATER   ([[[UIDevice currentDevice]systemVersion]floatValue] >=11.0)
// 是否空对象
...
#if DEBUG
// 测试环境
#define kGtAppId           @"Z4oQtHjgSIAF9Jxs2Ggy83"
#define kGtAppKey          @"vG7nGkpZMZ8i0j8AdfUTqA"
#define kGtAppSecret       @"lYCtUPsZH96v02qAajLCB9"
#else
// 正式环境
#define kGtAppId           @"Z4oQtHjgSIAF9Jxs2Ggy83"
#define kGtAppKey          @"vG7nGkpZMZ8i0j8AdfUTqA"
