            ...
            dismissBlock:(dispatch_block_t)dismissBlock
{
    ...
    popView.lbTitle.textAlignment=NSTextAlignmentLeft;
...
//    popView.leftBtn.backgroundColor=[UIColor grayColor];
    [popView.rightBtn setTitleColor:RGB(50, 133, 251) forState:UIControlStateNormal];
    [popView.leftBtn setTitleColor:[UIColor darkGrayColor] forState:UIControlStateNormal];
...
//    [popView.rightBtn setTitleColor:[UIColor whiteColor] forState:UIControlStateNormal];
    ...
    if (doTransform) {
        popView.transform = CGAffineTransformMakeRotation(M_PI_2);
    }
}
...
-(void)resetFrame{
    ...
    
    {
        ...
        frame.size.height=MIN(labelSize.height, (kAlertWidth - 20)*9/16);
    ...
    
    {
        ...
        frame.size.height=MIN(labelSize1.height, (kAlertWidth - 20)*9/16);
