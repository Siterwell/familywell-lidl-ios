...
#import "LocWeatherView.h"

@implementation LocWeatherView {
    UIImageView *weaIcon;
    UILabel *addressLb;
    UILabel *lb1;
    UILabel *lb2;
...
//    [weaIcon sd_setImageWithURL:[NSURL URLWithString:[NSString stringWithFormat:@"https://openweathermap.org/themes/openweathermap/assets/vendor/owm/img/widgets/%@.png", self.model.icon]] placeholderImage:[UIImage imageNamed:@"weather_icon"]];
